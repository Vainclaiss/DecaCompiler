// Generated from /home/unmars/ENSIMAG/2A/GL/Projet_GL/src/main/antlr4/fr/ensimag/deca/syntax/DecaParser.g4 by ANTLR 4.13.1
...
public class DecaParser extends AbstractDecaParser {
	...
	public static final int
		ESPACE=1, STRING=2, PRINTLN=3, OPARENT=4, CPARENT=5, SEMI=6, OBRACE=7, 
		CBRACE=8, COMMA=9, EQUALS=10, PRINT=11, PRINTX=12, PRINTLNX=13, WHILE=14, 
		RETURN=15, IF=16, ELSE=17, OR=18, AND=19, EQEQ=20, NEQ=21, LEQ=22, GEQ=23, 
		GT=24, LT=25, INSTANCEOF=26, PLUS=27, MINUS=28, TIMES=29, SLASH=30, PERCENT=31, 
		EXCLAM=32, DOT=33, READINT=34, READFLOAT=35, NEW=36, INT=37, FLOAT=38, 
		TRUE=39, FALSE=40, THIS=41, NULL=42, IDENT=43, CLASS=44, EXTENDS=45, PROTECTED=46, 
		ASM=47, MULTI_LINE_STRING=48;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "ESPACE", "STRING", "PRINTLN", "OPARENT", "CPARENT", "SEMI", "OBRACE", 
			"CBRACE", "COMMA", "EQUALS", "PRINT", "PRINTX", "PRINTLNX", "WHILE", 
			"RETURN", "IF", "ELSE", "OR", "AND", "EQEQ", "NEQ", "LEQ", "GEQ", "GT", 
			"LT", "INSTANCEOF", "PLUS", "MINUS", "TIMES", "SLASH", "PERCENT", "EXCLAM", 
			"DOT", "READINT", "READFLOAT", "NEW", "INT", "FLOAT", "TRUE", "FALSE", 
			"THIS", "NULL", "IDENT", "CLASS", "EXTENDS", "PROTECTED", "ASM", "MULTI_LINE_STRING"
		};
	}
	...
	public final List_instContext list_inst() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 17579569707100L) != 0)) {
				{
				{
				setState(122);
				inst();
	...
	public final List_exprContext list_expr() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 17579569578004L) != 0)) {
				{
				setState(214);
